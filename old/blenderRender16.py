...
#bpy.ops.mesh.primitive_cube_add(location = (0.044384,0.003504,0))  
#bpy.ops.mesh.primitive_cube_add(location = (0.304,0.024,0))
...
for num in range(start_frame,end_frame+1):
    ...
    bpy.data.objects["Mesh1"].name = 'Cube'
    bpy.data.objects["Cube"].dimensions = (0.0036208,0.003504,0.0146)
