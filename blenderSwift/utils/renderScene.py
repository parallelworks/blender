...
camPos.option='none'
camPos.location=[camTraject[sceneNumber,0]-2,camTraject[sceneNumber,1],camTraject[sceneNumber,2]]
camPos.focus=[camTraject[sceneNumber+1,0]-2,camTraject[sceneNumber+1,1],camTraject[sceneNumber+1,2]]
...
#bpy.data.scenes['Scene'].render.filepath = path2blended+str(sceneNumber).zfill(4)
